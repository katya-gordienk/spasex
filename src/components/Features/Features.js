  ...
  <section className="features">
    ...
    <div className="overview">
      <table className="table">
        ...
        <thead>
          <tr>
            <td clasName="table-column">22.25 m / 73 ft</td>
          </tr>
          <tr>
      ...
      <article>
        ...
        <p className="features-text">
          The Falcon 1 was an expendable launch system privately developed and manufactured by SpaceX during 2006-2009. On 28 September 2008, Falcon 1
          became the first privately-developed liquid-fuel launch vehicle to go into orbit around the Earth.
        </p>
      </article>
    </div>
  </section>
